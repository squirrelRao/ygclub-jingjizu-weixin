	...
	<head>
		...
		<script type="text/javascript">
			...
			function admin_login(){
				...
				var url = "../core/controller/AdminController.php?action=login"+params;
//				alert(url);
				$.ajax({
					type:"get",
					url: url,
...
//						alert(data);
						...
						if(obj.ret_code == "200"){
			     			...
			     			document.location.href='activity_admin.php?type=signup&username='+username;
	...
	<body>
		...
		<div class="mui-content" height="100%">
		    ...
		    <h5 ><span class="mui-icon mui-icon-flag"></span>密码</h5>	
		    <input type="password" name="password" id="password"  value="" />	    
			<div class="mui-button-row">
				<button class="mui-btn mui-btn-positive mui-btn-primary" style="width:280px;height:40px;" onclick="admin_login()">登 录</button>
		</div>
		</div>
			</div>
		</div>
